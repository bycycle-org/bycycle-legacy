...
bicycle. It uses different data modes and associated weighting functions to do 
trip planning for different datasets and travel modes.
...
Using the web service, creating an AJAX-enhanced Web interface (for example) 
...
easily incorporating and using new sets of data.
...
system for any purpose whatsoever without purchasing a license to do so. 
Please see the file LICENSE.txt for details of the GPL.
