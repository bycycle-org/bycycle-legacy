...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml">
  ...
  <head>
    ...
    <!-- We want access to these JavaScripts during page load. -->
...
% #for
  ...
  <body>
	...
	<tbody>
	  <tr>
	    <td class="header">
	      <div>
 	        <span id="logo">
		  <a href="http://www.bycycle.org/" title="byCycle.org Home Page">byCycle</a>&nbsp;-&nbsp;<a href="http://tripplanner.bycycle.org/">Bicycle Trip Planner</a> <small>[<a href="http://en.wikipedia.org/wiki/Development_stage#Beta">beta</a>]</small>&nbsp;-&nbsp;
		</span>

		<!-- Region -->
		<span id="regions_container">
		  <span id="active_region">All Regions</span>
		  <small><a href="/Regions" onclick="byCycle.UI.showRegionSelectBox(); return false;">change</a></small>
		  <div id="regions_win" class="window">
		    ...
		    <div class="content_pane">
		      <form id="regions_form" method="get" action="" onsubmit="return false;">
			...
			<noscript>
			  <input id="change_region_button" name="rb" type="submit" value="Go!" />
			</noscript>
		      </form>
		    </div>
		  </div>
    ...
    <!-- Input -->
    <div id="input" class="page_section tab_pane">
	...
	<div class="tab_content">
	  ...
	  <form id="query_form" method="get" action="" onsubmit="return false;">
	    <div>
	      ...
	      <input name="qb" type="submit" value="Search Map" title="Click to search the map" tabindex="9" />
	...
	<div class="tab_content" style="display: none;">
	  ...
	  <form id="route_form" method="get" action="" onsubmit="return false;">
	    <div>
		 ...
		 ><img src="/images/swapfrto.png" alt="<>" width="20" height="14" /></a><input id="to" name="to" type="text" value="<% c.to %>" title="End address/intersection" tabindex="6" />
	      <select id="pref" name="pref" tabindex="8">
		<option value="">
		  - Route Type -
		  </option><option value="">
		  Normal
		  </option><option value="safer">
		  Safer
		</option>
	      </select>
	      <input name="rb" type="submit" value="Find Route" title="Click to find a route" tabindex="9" />
	    </div>
	    <div class="input_label">
	      Enter your start and end addresses & select a route type (optional).
	    </div>
	  </form>
	  <!-- End Route Form -->
	</div>
    ...
    <div class="page_section" style="background: #fffa73;">
      <table style="width: 100%; border-collapse: collapse;">
	<tbody>
	  <tr>
	    <td>
	      <div id="status">
		Welcome to the <a href="http://byCycle.org/">byCycle</a> <a href="http://TripPlanner.byCycle.org/">bicycle trip planner</a>.
	      </div>
	      <% c.message %>
	    </td>
	    <td>
	      <div id="links">
	        <a id="bookmark" href="/" 
		   title="Link to the current result">Bookmark</a> &middot; 
	        <a href="" onclick="return false;" 
		   title="Show Trip Planner Help">Help</a> &middot; 
		<a href="" onclick="return false;"
	  ...
	  <tr>
		...
		<div id="info">
		  <p style="margin-top: 0;">
		    Welcome to the <a href="http://www.bycycle.org/" title="byCycle.org Home Page">byCycle</a> bicycle trip planner.
		  </p>
		  <p>
